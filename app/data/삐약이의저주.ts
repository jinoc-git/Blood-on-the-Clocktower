...
export const JOBS: Job[] = [
  ...
  },
  {
    ...
    ability:
      '스토리텔러는 낮에 공개적으로 고스트 판임을 선언합니다. 당신이 투표로 처형된다면 스토리텔러는 그 자리에서 악마1명과 시민2명을 남기고 모두 죽입니다.',
    team: 'minion',
  },
  {
    id: '231',
  ...
  },
  {
    ...
    ability:
      '매일 밤, 플레이어를 선택하세요. 그는 죽습니다. 팡키는 하수인이 될 플레이어와 종류를 직접 고릅니다. 그들은 본인이 받은 직업을 잃고 하수인이 됩니다. 이방인을 고를시 다시 선택해야 하며 주어지는 블러핑 직업은 2개 입니다.',
    reminders: [
      '독살범',
      '마녀',
      '선비',
