...
export const JOBS: Job[] = [
  ...
  },
  {
    ...
    ability:
      '고스트는 팀과 회의할 필요가 없습니다. 스토리텔러는 낮에 공개적으로 고스트를 밝히고 시작합니다. 당신이 죽었든 살았든 3명의 시민이 처형되면 악팀의 승리입니다. 고스트는 세레노부스와 함께 플레이 중일 수 없습니다.',
    reminders: ['1명', '2명', '3명'],
    team: 'minion',
  },
  {
    ...
    ability:
      '매일 밤, 플레이어를 선택하세요. 그는 죽습니다. 당신이 죽인 하수인은 능력을 유지하고 그 하수인의 양 옆에 앉아있는 마을 시민 중 1명은 중독 상태가 됩니다. ( 이미 죽어있는 시민이어도 무조건 양 옆에 앉아있는 시민 중 1명이 중독 ) -1 이방인',
    firstNight: 22,
    firstNightReminder:
  ...
  },
  {
    ...
    ability:
      '매일 밤, 플레이어를 선택하세요. 그는 죽습니다. 당신은 매혹시킬 플레이어를 매일 밤 선택 할 수 있으며 당신 포함 5명 이상의 플레이어가 살아있을때 처형되면 새팡키를 고를 수 있습니다. 성자를 고를시 악팀의 패배입니다.(-1 하수인)',
    reminders: ['매 혹', '새 팡 키'],
    team: 'demon',
  },
];
