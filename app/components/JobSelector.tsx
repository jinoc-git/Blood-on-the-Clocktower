...
const JobSelector: React.FC<JobSelectorProps> = ({ onJobSelect, selectedJobs, onJobClick }) => {
  const getJobColor = (category: string) => {
    switch (category) {
      case 'villager': return 'bg-blue-500 hover:bg-blue-600';
      case 'outsider': return 'bg-sky-400 hover:bg-sky-500';
      case 'minion': return 'bg-red-500 hover:bg-red-600';
      case 'demon': return 'bg-red-700 hover:bg-red-800';
