...
export const JOBS_SPARTA: Job[] = [
  {
    id: 'sculptorfallofrome',
    name: '조각가',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/sculptor_fall_of_rome.png',
      'https://user-images.klutzbanana.com/px8bww0ren2cmagbybznoqij.png',
    ],
    team: 'townsfolk',
    ability:
      '플레이어 1명을 알고 시작합니다. 매일 밤*, 그가 가장 최근에 지명한 플레이어의 성향을 알게 됩니다.',
    firstNight: 18,
    otherNight: 19,
    firstNightReminder:
      "플레이어 한 명을 선택합니다. 해당 플레이어 옆에 'SCULPTURE' 토큰을 놓습니다.",
    otherNightReminder:
      "만약 '조각상' 토큰을 가진 플레이어가 오늘 누군가를 선택했다면, 선택된 플레이어가 악한 진영일 경우 조각가에게 엄지를 아래로 내린 '악' 수신호를 보여줍니다. 그렇지 않다면 조각가에게 엄지를 위로 올린 '선' 수신호를 보여줍니다. (만약 있다면) '지명함' 토큰을 제거합니다.",
    reminders: ['조각상', '지명함'],
  },
  {
    id: 'vestalvirginfallofrome',
    name: '베스타의 무녀',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/vestalvirgin_fall_of_rome.png',
      'https://user-images.klutzbanana.com/c30m913ex82u702w3jizf7zj.png',
    ],
    team: 'townsfolk',
    ability:
      '선 캐릭터 1개와 악 캐릭터 1개를 알고 시작합니다. 둘 중 1개는 플레이 중입니다. 그가 죽으면, 그날 밤, 선 캐릭터 1개와 악 캐릭터 1개를 알게 됩니다. 둘 중 1개는 플레이 중입니다.',
    firstNight: 19,
    otherNight: 20,
    firstNightReminder:
      "선한 캐릭터 토큰 1개와 악한 캐릭터 토큰 1개를 보여줍니다. 이 중 하나는 현재 게임에 참여 중입니다. 게임에 참여 중인 캐릭터 옆에 '배움' 토큰을 놓습니다.",
    otherNightReminder:
      "만약 '배움' 토큰을 가진 플레이어가 오늘 사망했다면, 토큰을 제거합니다. 베스타의 무녀를 깨워 선한 캐릭터 토큰 1개와 악한 캐릭터 토큰 1개를 보여줍니다. 이 중 하나는 현재 게임에 참여 중입니다. 게임에 참여 중인 캐릭터 옆에 '배움 토큰을 놓습니다.",
    reminders: ['배움'],
  },
  {
    id: 'physicianfallofrome',
    name: '의사',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/physician_fall_of_rome.png',
      'https://user-images.klutzbanana.com/zdndwom9gk1pcp19ucc0xq2w.png',
    ],
    team: 'townsfolk',
    ability:
      '매일 밤, 2명을 선택합니다.(본인 제외) 그들은 술에서 깨고, 건강해지며, 올바른 정보를 받습니다. 처음으로 악마가 그들 중 1명을 죽이면, 당신은 악마의 타입을 알게 됩니다.',
    firstNight: 17,
    otherNight: 11,
    firstNightReminder:
      "의사는 자신이 아닌 플레이어 두 명을 선택합니다. 두 플레이어 모두를 'PATIENT' 토큰으로 표시합니다.",
    otherNightReminder:
      "모든 '환자' 토큰을 제거합니다. 의사는 자신이 아닌 두 명의 플레이어를 선택합니다. 두 플레이어 모두를 'PATIENT' 토큰으로 표시합니다. 만약 '환자' 토큰을 가진 플레이어가 악마에게 살해당했다면, 의사 옆에 '처음 악마' 토큰을 놓고 의사를 깨워 악마 토큰을 보여줍니다.",
    reminders: ['환자', '환자', '처음 악마'],
  },
  {
    id: 'legionaryfallofrome',
    name: '군단병',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/legionary_fall_of_rome.png',
      'https://user-images.klutzbanana.com/f3rlxanq2t706huo3dsdfuuh.png',
    ],
    team: 'townsfolk',
    ability:
      '매일 밤, 자신과, 시계방향으로 가까운 살아있는 군단병 사이에 살아있는 악이 몇 명 있는지 알게 됩니다. [+0 ~ +2 군단병]',
    firstNight: 20,
    otherNight: 21,
    firstNightReminder:
      '군단병과 (시계 방향으로) 다음 군단병 사이에 있는 살아있는 악한 플레이어의 수(0, 1, 2 등)를 수신호로 보여줍니다. (본인 제외)',
    otherNightReminder:
      '군단병과 (시계 방향으로) 다음 군단병 사이에 있는 살아있는 악한 플레이어의 수(0, 1, 2 등)를 수신호로 보여줍니다. (본인 제외)',
    setup: true,
    special: [
  ...
  {
    id: 'trumpeterfallofrome',
    name: '나팔수',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/trumpeter_fall_of_rome.png',
      'https://user-images.klutzbanana.com/eex3zrdx5mkln6ple7cv20cn.png',
    ],
    team: 'townsfolk',
    ability:
      "매일 밤*, 오늘 낮에 공개적으로 '스파르타쿠스'라고 주장한 악이 몇 명 이었는지 알게 됩니다.",
    firstNight: 0,
    otherNight: 22,
    otherNightReminder:
      '오늘 낮에 공개적으로 자신이 스파르타쿠스라고 주장한 악한 플레이어의 수(0, 1, 2 등)를 수신호로 보여줍니다.',
    reminders: [
      '악 주장함',
      '악 주장함',
      '악 주장함',
  ...
  {
    id: 'morticianfallofrome',
    name: '장의사',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/mortician_fall_of_rome.png',
      'https://user-images.klutzbanana.com/coho1s8lmtqgpywyps4o6ypa.png',
    ],
    team: 'townsfolk',
    ability:
      '매일 밤*, 오늘 낮에 처형으로 죽은 플레이어의 살아있는 이웃 중 악이 있는지 알게 됩니다.',
    firstNight: 0,
    otherNight: 23,
    otherNightReminder:
      '만약 오늘 플레이어 한 명이 처형되었다면: 이웃 중 한 명이 악한 진영인지 여부를 머리 신호(있다면 끄덕이고, 없다면 가로저음)로 보여줍니다.',
    reminders: ['최근 처형'],
  },
  {
    id: 'standardbearerfallofrome',
    name: '군단기수',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/standardbearer_fall_of_rome.png',
      'https://user-images.klutzbanana.com/ldnrs36wsv24odipfl4w2yuy.png',
    ],
    team: 'townsfolk',
    ability:
      '당신이 지명당했을 때, 지명한 플레이어에 대해 (본인 제외) 공개적으로 유일무이한 발언 1개를 할 수 있습니다. 오늘 밤, 그 발언이 사실이었는지 알게 됩니다.',
    firstNight: 0,
    otherNight: 24,
    otherNightReminder:
      '만약 군단기수의 공개적인 발언이 참이라면: 참 거짓 여부를 머리 신호로 보여줍니다.',
    reminders: ['참', '거짓'],
  },
  {
    id: 'centurion1fallofrome',
    name: '백인대장',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/centurion1_fall_of_rome.png',
      'https://user-images.klutzbanana.com/lqd7a5t9jxpu5jqsoy31mgoq.png',
    ],
    team: 'townsfolk',
    ability:
      "당신이 살아있는 플레이어를 지명하고, 그가 처형당하면 그의 팀이 패배합니다. 당신은 악마로부터 안전합니다. 오늘 낮에 공개적으로 '스파르타쿠스' 라고 주장했다면 새벽까지 술에 취합니다.",
    firstNight: 0,
    otherNight: 0,
    reminders: ['취함'],
  },
  {
    id: 'merchantfallofrome',
    name: '상인',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/merchant_fall_of_rome.png',
      'https://user-images.klutzbanana.com/crp82s07s1cf8ofhmb7ud4uf.png',
    ],
    team: 'townsfolk',
    ability:
      '게임당 한 번, 밤에*, 어떤 캐릭터들이 당신을 지명했는지 알 수 있습니다.',
    firstNight: 0,
    otherNight: 26,
    otherNightReminder:
      "만약 상인이 아직 능력을 사용하지 않았다면: 상인은 부정의 의미로 고개를 가로젓거나, 긍정의 의미로 고개를 끄덕입니다. 상인이 '긍정'을 선택했다면, '지명함' 토큰을 가진 플레이어들의 캐릭터 토큰을 (순서와 상관없이) 보여줍니다. '능력 없음' 토큰을 놓습니다",
    reminders: [
      '지명함',
      '지명함',
      '지명함',
  ...
  {
    id: 'gladiatorfallofrome',
    name: '검투사',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/gladiator_fall_of_rome.png',
      'https://user-images.klutzbanana.com/pguv03ckcsse7teckmro9jft.png',
    ],
    team: 'townsfolk',
    ability:
      "게임당 한 번, 낮에, 공개적으로 살아있는 1명을 선택합니다. 오늘 밤, 그와 당신은 조용히 일어나서 '가위바위보'를 합니다. 패배자는 죽습니다. (누군가는 져야 합니다.)",
    firstNight: 0,
    otherNight: 18,
    otherNightReminder:
      '만약 검투사가 오늘 능력을 사용했다면, 검투사와 그가 선택한 플레이어를 깨웁니다: 두 플레이어는 조용히 가위바위보를 합니다. 비겼다면 다시 합니다. 누군가 이길 때까지 계속합니다. 패배한 플레이어는 사망합니다.',
    reminders: ['결투', '죽음', '능력 없음'],
  },
  {
    id: 'actorfallofrome',
    name: '배우',
    image: [
      ...
      'https://user-images.klutzbanana.com/egz7vio99de2b4avxj8x8xy4.png',
    ],
    team: 'townsfolk',
    ability:
      '게임당 한 번, 낮에, 공개적으로 플레이어의 캐릭터 타입 3개를 추측합니다. (본인 제외, 타입당 1개) 그날 밤, 그중 몇 개가 맞았었는지 알게 됩니다.',
    firstNight: 0,
    otherNight: 25,
    otherNightReminder:
      "오늘 배우가 능력을 사용했다면 '맞음' 토큰 개수(0, 1, 2 또는 3)를 수신호로 보여줍니다. 그 후, 해당 플레이어에게 '능력 없음' 토큰을 배치합니다.",
    reminders: ['맞음', '맞음', '맞음', '능력 없음'],
  },
  {
    id: 'blacksmithfallofrome',
    name: '대장장이',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/blacksmith_fall_of_rome.png',
      'https://user-images.klutzbanana.com/ftg6vouz69ew608utizcghq0.png',
    ],
    team: 'townsfolk',
    ability:
    ...
    otherNight: 17,
    otherNightReminder:
      "대장장이가 악마에게 살해당했다면: 대장장이에게 게임에 참가 중이지 않은 마을주민 캐릭터 토큰을 보여줍니다. 참가 중이지 않은 캐릭터 토큰을 대장장이 토큰과 교체합니다. 참가 중이지 않았던 캐릭터 토큰 옆에 '대장장이' 토큰을 놓습니다. 대장장이를 깨워 캐릭터 정보와 새로운 캐릭터 능력을 보여줍니다.",
    reminders: ['대장장이'],
  },
  {
    id: 'scholarfallofrome',
    name: '학자',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/scholar_fall_of_rome.png',
      'https://user-images.klutzbanana.com/cdj91mjv834bitygc0e44gy6.png',
    ],
    team: 'townsfolk',
    ability:
    ...
    otherNight: 2,
    otherNightReminder:
      "만약 학자가 오늘 외부인을 지명했다면, '능력없음' 토큰을 놓습니다. 지명된 플레이어를 깨웁니다. '강의 들음' 토큰을 넣고 정보와 그들의 새로운 캐릭터 토큰을 보여줍니다.",
    reminders: ['강의 들음', '능력 없음'],
    setup: true,
  },
  {
    id: 'martyrform',
    name: '순교자',
    image: [
      'https://user-images.klutzbanana.com/uhz7vqwpai44so1b3pi6t2ro.png',
      'https://user-images.klutzbanana.com/bgfjexebcgkdp7nb8cqcnddt.png',
    ],
    team: 'townsfolk',
    ability:
      '당신이 처형된다면, 공개적으로 2명을 선택하세요. 당신과 그들 모두 선한 마을 주민이고 당신이 중독되지 않았다면 오늘 밤 그들은 당신을 알게 됩니다. 당신은 스스로를 지목해 처형 당할 경우 능력이 발동되지 않습니다.',
    firstNight: 0,
    otherNight: 1,
    otherNightReminder:
      '순교자가 지목한 그들이 모두 선한 진영이고 중독되거나 불길한 징조가 아니라면 지목된 플레이어에게 그 캐릭터를 알려주세요.',
    reminders: ['선택함', '선택함'],
  },
  {
    id: 'elderform',
    name: '원로장',
    image: [
      'https://user-images.klutzbanana.com/tdnc8wy01kf54ewio58qprzc.png',
      'https://user-images.klutzbanana.com/zbf7mkk22hvbh4zix0s3h62x.png',
    ],
    team: 'townsfolk',
    ability:
      '당신이 처형 투표에 참여했고 그 처형이 성공했다면 당신은 오늘 밤 스토리텔러에게 승리에 도움이 되는 1가지 조언을 듣습니다. 당신의 살아있는 이웃중 악한 진영이 있다면 잘못된 정보를 받습니다.',
    firstNight: 0,
    otherNight: 1,
    otherNightReminder:
      "원로장이 참여한 투표에 참여한 플레이어가 처형된다면, '처형예정' 토큰을 놓습니다. 밤이 찾아온다면  '조언' 토큰을 넣고 다음날 아침 원로장이 찾아온다면  조언을 해주고 '조언' 토큰을 제거해주세요.",
    reminders: ['처형예정', '투표함', '조언', '잘못된 조언'],
  },
  {
    id: 'thetwinsfallofrome',
    name: '쌍둥이',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/thetwins_fall_of_rome.png',
      'https://user-images.klutzbanana.com/rgbyelzm1yf5ycgj6zfxghnp.png',
    ],
    team: 'outsider',
    ability:
      '플레이어 1명을 알고 시작합니다. 당신이나 그가 처형당하면, 모든 마을 주민은 내일 해가 질 때까지 술에 취합니다.',
    firstNight: 16,
    otherNight: 10,
    firstNightReminder:
      "플레이어 한 명을 선택해 해당 플레이어 옆에 '레무스' 토큰을 놓습니다.",
    otherNightReminder:
      "만약 쌍둥이가 '마을 주민들 취함' 토큰을 가지고 있다면, 모든 마을주민은 황혼까지 취한 상태가 됩니다.",
    reminders: ['쌍둥이', '마을 주민 취함'],
  },
  {
    id: 'winemakerfallofrome',
    name: '와인제조자',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/winemaker_fall_of_rome.png',
      'https://user-images.klutzbanana.com/y0twdy5rh9ht6q2gr4tr0xj1.png',
    ],
    team: 'outsider',
    ability:
      '당신에게 이웃한 2명의 마을 주민은 술에 취합니다. 그러나 격일 밤마다 (홀수/짝수 밤), 당신은 해가 질 때까지 술에 취합니다. 당신이 죽더라도 동일합니다.',
    firstNight: 15,
    otherNight: 9,
    firstNightReminder:
      "'홀수' 또는 '짝수' 토큰 중 하나를 놓습니다. 만약 '홀수'를 놓았다면, 와인제조자는 첫날 밤과 그 후 격일 밤마다 취한 상태가 됩니다. 그렇지 않다면: 와인제조자는 둘째 날 밤과 그 후 격일 밤마다 취한 상태가 됩니다.",
    otherNightReminder:
      "'홀수' 또는 '짝수'이 놓여 있는지 확인합니다. 홀수 번째 밤에 '홀수' 토큰이 놓여 있다면, 와인제조자는 황혼까지 취한 상태가 됩니다. 짝수 번째 밤에 '짝수' 토큰이 놓여 있다면, 와인제조자는 황혼까지 취한 상태가 됩니다. 그렇지 않다면 와인제조자의 마을주민 이웃들이 황혼까지 취한 상태가 됩니다.",
    reminders: ['홀수', '짝수', '취함', '취함'],
  },
  {
    id: 'spartacusfallofrome',
    name: '스파르타쿠스',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/spartacus_fall_of_rome.png',
      'https://user-images.klutzbanana.com/aduq2rfkywr7118e03y8zq47.png',
    ],
    team: 'outsider',
    ability:
      "악한 플레이어가 당신을 공개적으로 추측하면 (한 번) 당신의 팀은 패배합니다. 마을 주민으로 보일 수 있습니다. 매일 낮, '스파르타쿠스' 라고 주장하지 않으면, 마을 주민으로 보일 수 없습니다.",
    firstNight: 0,
    otherNight: 0,
    reminders: ['추측 사용됨'],
  },
  {
    id: 'badomenfallofrome',
    name: '불길한 징조',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/badomen_fall_of_rome.png',
      'https://user-images.klutzbanana.com/c8yaycwia9l2rnkgjfuovmxb.png',
    ],
    team: 'outsider',
    ability:
      "자신이 '불길한 징조' 라는 것을 모릅니다. 마을 주민이라고 생각하지만 그렇지 않고, 잘못된 정보를 받습니다. 당신은 악으로 보일 수 있고, 죽더라도 그렇습니다.",
    firstNight: 0,
    otherNight: 0,
    remindersGlobal: [
      '불길한 징조',
  ...
  },
  {
    ...
    team: 'minion',
    ability:
      '당신의 첫 번째 밤에, 2명을 선택합니다. 그들은 자신이 선택된 것을 알게 됩니다. 처음으로 그들 중 1명이 처형으로 죽을 때, 나머지 1명이 악이 됩니다.',
    firstNight: 12,
    otherNight: 3,
    firstNightReminder:
      "요부가 플레이어 두 명을 가리킵니다. 두 플레이어 옆에 '유혹됨' 토큰을 놓습니다. 두 플레이어를 각각 따로 깨웁니다. 요부에게 유혹 당했음을 알려 줍니다.",
    otherNightReminder:
      "만약 '요부선택' 토큰을 가진 플레이어가 처형되어 사망하면, 해당 플레이어의 '요부선택' 토큰을 제거합니다. '요부선택' 토큰이 남은 다른 플레이어는 악한 진영으로 변합니다. 그 플레이어의 '요부선택' 토큰을 제거하고 '악' 토큰으로 교체합니다. 악해진 플레이어를 깨워 엄지를 아래로 내린 '악' 수신호를 보여줍니다.",
    reminders: ['요부선택', '요부선택', '악'],
  },
  {
    id: 'haruspexfallofrome',
    name: '내장 점술가',
    image: [
    ...
    team: 'minion',
    ability:
      '매일 밤, 1명을 선택합니다. 그의 캐릭터를 알게 됩니다. 이 방법으로, 당신이 처음으로 2번 선택한 플레이어는 죽습니다. [+1 스파르타쿠스]',
    firstNight: 14,
    otherNight: 16,
    firstNightReminder:
      "내장 점술가가 플레이어 한 명을 가리킵니다. 해당 플레이어의 캐릭터 토큰을 보여줍니다. 그 플레이어 옆에 '예지함' 토큰을 놓습니다.",
    otherNightReminder:
      "내장 점술가가 플레이어 한 명을 가리킵니다. 해당 플레이어의 캐릭터 토큰을 보여줍니다. 만약 그 플레이어가 이미 '예지함' 토큰을 가지고 있다면, 플레이어 옆에 '예지함' 토큰을 놓습니다. 해당 플레이어는 사망하며, 내장 점술가 옆에 '죽일 수 없음' 토큰을 놓습니다.",
    reminders: [
      '예지함',
      '예지함',
      '예지함',
  ...
  {
    id: 'glykon1fallofrome',
    name: '글리콘',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/glykon1_fall_of_rome.png',
      'https://user-images.klutzbanana.com/jb56emejkwss1m9mdu4s36k4.png',
    ],
    team: 'minion',
    ability:
      '당신은 선으로 보일 수 있습니다. 당신이 지명하는 플레이어는 새벽까지 반대 성향으로 보입니다. 그가 마을 주민이라면, 추가적으로 새벽까지 중독됩니다.',
    firstNight: 0,
    otherNight: 0,
    reminders: ['반대성향', '중독'],
  },
  ...
  },
  {
    ...
    team: 'demon',
    ability:
      '매일 밤, 2명을 선택합니다. 그들이 내일 지명하면, 그날 밤 죽습니다. 매일 낮, 선한 플레이어가 지명하지 않는다면 (여행객 제외), 악이 승리합니다.',
    firstNight: 13,
    otherNight: 12,
    firstNightReminder:
      "클레오파트라가 참가자 2명을 가리킵니다. 선택한 참가자 위에 '선택됨' 토큰을 놓습니다.",
    otherNightReminder:
      "'선택됨' 토큰이 놓여진 플레이어가 오늘 누군가를 지명했다면 그 플레이어는 사망합니다. 모든 '선택됨' 토큰을 제거합니다. 클레오파트라는 플레이어 두 명을 가리킵니다. 두 플레이어 모두 옆에 '선택됨' 토큰을 놓습니다.",
    reminders: ['선택됨1', '선택됨2', '죽음', '죽음'],
  },
  {
    id: 'crassusfallofrome',
    name: '크라수스',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/crassus_fall_of_rome.png',
      'https://user-images.klutzbanana.com/ox25vuc8b2005im0sj3yhyle.png',
    ],
    team: 'demon',
    ability:
      "매일 밤*, 1명을 선택합니다. 그는 죽습니다. 첫 번째 크라수스가 공개적으로 '스파르타쿠스' 라고 주장하고, 5명 이상이 살아있을 때 죽으면, 악 1명이 크라수스가 됩니다.",
    firstNight: 0,
    otherNight: 13,
    otherNightReminder:
      "크라수스가 참가자 1명을 가리킵니다. 해당 플레이어는 사망합니다. 만약 첫 번째 크라수스가 오늘 공개적으로 자신이 스파르타쿠스라고 주장한 뒤 사망했다면, 그리고 살아있는 플레이어가 5명 이상이라면, 악한 플레이어 한 명의 캐릭터를 여분의 크라수스 토큰으로 교체합니다. '당신은'  크라수스 캐릭터 토큰을 차례로 보여줍니다.",
    reminders: ['죽음', '첫번째'],
  },
  {
    id: 'hannibalfallofrome',
    name: '한니발',
    image: [
      'https://www.bloodstar.xyz/p/AlexS/Fall_of_Rome/hannibal_fall_of_rome.png',
      'https://user-images.klutzbanana.com/g5s9ajrctsow2vh63hcm5c0y.png',
    ],
    team: 'demon',
    ability:
      '선한 캐릭터라고 생각하지만, 그렇지 않습니다. 하수인들은 블러프 3개를 알게 됩니다. 매일 밤*, 1명이 죽을 수 있습니다. 첫 번째로 죽은 한니발은 선이 됩니다. [+1 한니발]',
    firstNight: 11,
    otherNight: 14,
    firstNightReminder:
      "선한 플레이어 두 명을 선택하고 '한니발' 알림 토큰을 놓습니다. 모든 하수인을 함께 깨워 한니발들을 보여주고, 현재 플레이 중이지 않은 캐릭터 토큰 세 개(모두 동일한 캐릭터여야 함)를 보여줍니다.",
    otherNightReminder:
      "이야기꾼이 플레이어 한 명을 선택한다면 그 플레이어는 사망합니다. 만약 오늘 한니발이 사망했다면, 해당 플레이어를 깨워 '당신은' 카드와 한니발 토큰, 그리고 엄지를 위로 올린 '선' 수신호를 보여줍니다.",
    remindersGlobal: ['한니발', '한니발', '죽음', '죽음'],
    setup: true,
    special: [
      {
        name: 'bag-disabled',
  ...
  },
  {
    ...
    team: 'demon',
    ability:
      '매일 밤* 플레이어 1명을 선택 합니다. 선택한 플레이어는 죽습니다. 악한 플레이어가 처형으로 처음 사망한 날 추가로 한명 더 선택합니다. 그 플레이어도 사망합니다.(게임당 1번)',
    firstNight: 0,
    otherNight: 15,
    otherNightReminder:
      '오늘 악한 플레이어가 처형으로 사망했다면, 카이사르는 두 명의 플레이어를 선택합니다.(게임당 1번) 그렇지 않다면, 카이사르는 한 명의 플레이어를 선택합니다. 선택된  플레이어들은 사망합니다.',
    reminders: ['배반자', '2킬 가능', '2킬 불가능', '죽음', '죽음'],
  },
];
